...
print("Importation du modèle de vision CLIP pour la reconnaissance de scènes")
...
print("Importation du modèle de vision CLIPSeg pour la segmentation de scènes")
...
# Fonction (probImage,seuil) -> Fabrique une image de masque
def basicMaskFromProb(probImage,seuil):
    gray_image=np.array(probImage * 255, dtype = np.uint8)
